        ...
        <ul>
          <li>
            ...
            <ul>
              ...
              <li>photo</li>
              <li>credit</li>
              <li>usability (undecided, nice, usable, nah, album art, bio)</li>
            </ul>
          </li>
          <li>
            add new shoot
          ...
          <li>list of shoots & their photos (view / edit / delete - should be able to quickly assign usability to different photos at a glance)</li>
        </ul>
