        ...
        <main id="shows">
            ...
            <form id="show-form">
                ...
                <div className="form-row one-one-one">
                    ...
                    <div>
                        {/* <InputTime id="show-form-doors" label="When are doors?" hour="20" labeldisplay={true} /> */}
                    </div>
                    <div>
                        {/* <InputTime id="show-form-sound" label="When does sound start?" hour="21" labeldisplay={true} /> */}
                    </div>
                </div>
                ...
                <div className="form-row one-one-one">
                    ...
                    <div>
                        <InputSelect
                            ...
                            labeldisplay={true}
                            options={['world tour 2024', 'world tour 2025', 'world tour 2026']}
                        />
                    </div>
                    ...
                    <div>
                        <InputSelect
                            ...
                            labeldisplay={true}
                            options={['CV / home page', 'only in the gig log', 'hidden (just archiving)']}
                        />
                    </div>
                </div>

                <div className="divider">AFTERWARDS</div>
                <p className="explanation">Come back and put documentation here once it's over.</p>
