        ...
        <ul>
          <li>
            ...
            <ul>
              ...
              <li>liner notes (images of packaging, backcover.jpg or something)</li>
              <li>attachments (bonus stuff that might come with the bandcamp download or something - scores or something)</li>
              <li>editions</li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li>work</li>
              <li>how many CDs / cassettes / records / objects / other</li>
              <li>what label</li>
